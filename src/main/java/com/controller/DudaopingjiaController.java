...
public class DudaopingjiaController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DudaopingjiaEntity dudaopingjia, 
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DudaopingjiaEntity dudaopingjia, 
		HttpServletRequest request){
    ...
    public R add(@RequestBody DudaopingjiaEntity dudaopingjia, HttpServletRequest request){
    	dudaopingjia.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(dudaopingjia);
    	dudaopingjia.setUserid((Long)request.getSession().getAttribute("userId"));
