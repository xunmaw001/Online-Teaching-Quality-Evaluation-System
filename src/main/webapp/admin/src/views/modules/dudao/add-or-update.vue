<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="督导电话" prop="dudaodianhua">
          <el-input v-model="ruleForm.dudaodianhua" 
              placeholder="督导电话" clearable  :readonly="ro.dudaodianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="督导电话" prop="dudaodianhua">
              <el-input v-model="ruleForm.dudaodianhua" 
                placeholder="督导电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='dudaodianhua'){
            this.ruleForm.dudaodianhua = obj[o];
	    this.ro.dudaodianhua = true;
            continue;
          }
          if(o=='dudaoyouxiang'){
