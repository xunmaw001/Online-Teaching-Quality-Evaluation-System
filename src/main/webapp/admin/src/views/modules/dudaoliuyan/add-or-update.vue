<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="改进内容" prop="gaijinneirong">
          <el-input v-model="ruleForm.gaijinneirong" 
              placeholder="改进内容" clearable  :readonly="ro.gaijinneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="改进内容" prop="gaijinneirong">
              <el-input v-model="ruleForm.gaijinneirong" 
                placeholder="改进内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="督导留言" prop="dudaoliuyan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.dudaoliuyan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dudaoliuyan" label="督导留言" prop="dudaoliuyan">
                    <span v-html="ruleForm.dudaoliuyan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='gaijinneirong'){
            this.ruleForm.gaijinneirong = obj[o];
	    this.ro.gaijinneirong = true;
            continue;
          }
          if(o=='dudaoliuyan'){
            this.ruleForm.dudaoliuyan = obj[o];
	    this.ro.dudaoliuyan = true;
            continue;
          }
          if(o=='dudaogonghao'){
	...
	this.ruleForm.dudaoliuyan = this.ruleForm.dudaoliuyan.replace(reg,'../../../ssmo8x1z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dudaoliuyan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dudaoliuyanCrossAddOrUpdateFlag = false;
                  this.parent.search();
