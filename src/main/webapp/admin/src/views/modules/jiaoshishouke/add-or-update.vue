    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="授课计划" prop="shoukejihua">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shoukejihua" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shoukejihua" label="授课计划" prop="shoukejihua">
                    <span v-html="ruleForm.shoukejihua"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuanzeriqi = true;
          ...
          if(o=='shoukejihua'){
            this.ruleForm.shoukejihua = obj[o];
	    this.ro.shoukejihua = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
	...
	this.ruleForm.shoukejihua = this.ruleForm.shoukejihua.replace(reg,'../../../ssmo8x1z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiaoshishouke/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaoshishoukeCrossAddOrUpdateFlag = false;
                  this.parent.search();
