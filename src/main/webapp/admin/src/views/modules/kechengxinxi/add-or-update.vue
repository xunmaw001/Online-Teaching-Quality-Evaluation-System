  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kechengxuhao" label="课程序号" prop="kechengxuhao">
              <el-input v-model="ruleForm.kechengxuhao" 
                placeholder="课程序号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengjianjie = this.ruleForm.kechengjianjie.replace(reg,'../../../ssmo8x1z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
